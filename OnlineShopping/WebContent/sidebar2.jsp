...
%>
	...
	%>
		  <div class="thumbnail">
			<% out.print("<img src='"+file.getAbsolutePath()+"' alt='Bootshop panasonoc New camera'/>");%>
			<div class="caption">
			  <h5><%= name %></h5>
				<h4 style="text-align:center"><a class="btn" href="userviewproduct.jsp?Product_Id=<% out.print(id3);%>">View</a>
				 <a class="btn" href="addtocart.jsp?Product_Id=<% out.print(id3); %>">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#"> &#8377; &nbsp;<% out.print(price); %></a></h4>
			</div>
		  </div><br/>
		  <% 
		  }
