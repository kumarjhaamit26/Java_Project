...
<jsp:include page="sidebar2.jsp"></jsp:include>
	...
	File file=new File("C:\\MyWork\\OnlineShopping\\WebContent\\imagebyid\\image"+img+".jpg");
	...
	%>
            ...
            <a href="themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<% out.print("<img src='"+file+"' style='width:100%' alt='Fujifilm FinePix S2950 Digital Camera'/>");%>
            </a>
			...
			<div class="span6">
				...
				<option value="<% out.print(quantity);%>"><% out.print(quantity);%></option>
					   ...
					   <a class="btn btn-large btn-primary pull-right" href="addtocart.jsp?Product_Id=<%= id %>"> Add to cart</a>
